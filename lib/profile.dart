...
import 'package:my_pickup/splashscreen.dart';
...
class _ProfileState extends State<Profile> {
                                ...
                                child: Container(
                                    ...
                                    decoration: new BoxDecoration(
                                        ...
                                        image: new DecorationImage(
                                            fit: BoxFit.cover,
                                            image: new AssetImage("assets/images/defaultpic.png")
  ...
  void _takePicture() async {
    if (widget.driver.name == "not register") {
  ...
  void _changeName() {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        // return object of type Dialog
        return AlertDialog(
          title: new Text("Change " + widget.driver.name),
  ...
  void _changePassword() {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        // return object of type Dialog
        return AlertDialog(
          title: new Text("Change Password for " + widget.driver.name),
          content: new TextField(
  ...
  void _changePhone() {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        // return object of type Dialog
        return AlertDialog(
          title: new Text("Change phone for" + widget.driver.name),
          content: new TextField(
  ...
  void _gotologinPage() {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        // return object of type Dialog
        return AlertDialog(
          title: new Text("Go to login page?" + widget.driver.name),
          content: new Text("Are your sure?"),
          actions: <Widget>[
            // usually buttons at the bottom of the dialog
            new FlatButton(
            ...
            new FlatButton(
              ...
              onPressed: () async {
                ...
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => PaymentScreen(driver:widget.driver,orderid:formatted, val:_value)));
                }else{
